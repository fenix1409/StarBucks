        ...
        <div className='flex items-center justify-between max-sm:flex-col'>
            ...
            <div className="w-[457px] max-sm:w-[320px]">
                ...
                <div className="relative">
                    <img src={PRoces} alt="image" width={255} height={163} className='min-sm:hidden'/>
                    <img src={PRoces} alt="image" width={447} height={275} className='max-sm:hidden'/>
                    <Button title={"Cooking Process"} extraClass={'!w-[326px] max-sm:!w-[193px] !px-[42px] max-sm:!px-[25px] !py-[20px] max-sm:!py-[11px] !absolute !top-1/2 !left-1/2 max-sm:!left-[calc(1/2*77%)] !transform !-translate-x-1/2 !-translate-y-1/2'} />
                </div>
            </div>
        </div>
    )
